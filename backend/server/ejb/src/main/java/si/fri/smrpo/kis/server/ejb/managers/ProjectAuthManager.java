...
public class ProjectAuthManager extends AuthManager<Project> {
    ...
    @Override
    public CriteriaFilter<Project> authCriteria(DatabaseCore dbCore, Class<Project> c, CriteriaFilter<Project> criteriaFilter) throws DatabaseException {
        return (p, cb, r) -> {
