 ...
 */
package si.fri.smrpo.kis.core.lynx.utils;


import si.fri.smrpo.kis.core.lynx.beans.CriteriaField;
import si.fri.smrpo.kis.core.lynx.beans.CriteriaWhereQuery;
import si.fri.smrpo.kis.core.lynx.beans.QueryFilter;
import si.fri.smrpo.kis.core.lynx.beans.QueryParameters;
import si.fri.smrpo.kis.core.lynx.enums.OrderDirection;
import si.fri.smrpo.kis.core.lynx.exceptions.InvalidEntityFieldException;
import si.fri.smrpo.kis.core.lynx.exceptions.InvalidFieldValueException;
import si.fri.smrpo.kis.core.lynx.exceptions.NoSuchEntityFieldException;
...
public class JPAUtils {
    ...
    public static <T> List<T> queryEntities(EntityManager em, Class<T> entity, QueryParameters q) {
        ...
        return queryEntities(em, entity, q, null, false);
    }

    public static <T> List<T> queryEntities(EntityManager em, Class<T> entity, CriteriaFilter<T> customFilter) {

        return queryEntities(em, entity, new QueryParameters(), customFilter, false);
    }

    @SuppressWarnings("unchecked")
    public static <T> List<T> queryEntities(EntityManager em, Class<T> entity, QueryParameters q, CriteriaFilter<T> customFilter, boolean distinct) {
        ...
        Boolean requiresDistinct = distinct;
    ...
    public static <T> Long queryEntitiesCount(EntityManager em, Class<T> entity, QueryParameters q) {
        ...
        return queryEntitiesCount(em, entity, q, null, false);
    }

    public static <T> Long queryEntitiesCount(EntityManager em, Class<T> entity, CriteriaFilter<T> customFilter) {

        return queryEntitiesCount(em, entity, new QueryParameters(), customFilter, false);
    }

    public static <T> Long queryEntitiesCount(EntityManager em, Class<T> entity, QueryParameters q, CriteriaFilter<T> customFilter, boolean distinct) {
